...
module.exports = function() {
  ...
  this.use(express.session({ secret: 'lawn t@x3s', store: new mongo_store(process.env.MONGO_URL) }));
  // this.use(express.session({ secret: 'lawn t@x3s', cookie: { path: '/', httpOnly: true, maxAge: 86400} }));
